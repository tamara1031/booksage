...
func NewEntityResolver(v VectorRepository, t ports.TensorEngine) *EntityResolver {
...
func (er *EntityResolver) ResolveEntity(ctx context.Context, ent Entity) (string, bool, error) {
	if er.tensor == nil {
