...
func (s *SQLiteStore) GetDocumentByID(ctx context.Context, id int64) (*domain.Document, error) {
...
func (s *SQLiteStore) GetDocumentByHash(ctx context.Context, hash []byte) (*domain.Document, error) {
...
func (s *SQLiteStore) CreateSaga(ctx context.Context, saga *domain.IngestSaga) (int64, error) {
	now := time.Now().Unix()
...
func (s *SQLiteStore) GetSagaByID(ctx context.Context, id int64) (*domain.IngestSaga, error) {
...
func (s *SQLiteStore) GetLatestSagaByDocumentID(ctx context.Context, docID int64) (*domain.IngestSaga, error) {
...
func (s *SQLiteStore) UpdateSagaStatus(ctx context.Context, sagaID int64, currentVersion int, status domain.SagaStatus, currentStep domain.IngestStep, errorMsg string) error {
	now := time.Now().Unix()
...
func (s *SQLiteStore) UpsertSagaStep(ctx context.Context, step *domain.SagaStep) (int64, error) {
	now := time.Now().Unix()
	if step.ID == 0 {
		// Insert
...
func (s *SQLiteStore) GetSagaSteps(ctx context.Context, sagaID int64) ([]*domain.SagaStep, error) {
