...
func NewRaptorBuilder(llm domain.LLMClient) *RaptorBuilder {
...
func (b *RaptorBuilder) summarizeGroup(ctx context.Context, client domain.LLMClient, texts []string) (string, error) {
	if len(texts) == 0 {
		return "", nil
	}
