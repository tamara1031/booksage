...
func (m *MockQdrantClient) Search(ctx context.Context, vector []float32, limit int) ([]repository.SearchResult, error) {
	return nil, nil
}
...
func (m *MockNeo4jClient) SearchChunks(ctx context.Context, query string, limit int) ([]repository.SearchResult, error) {
	return nil, nil
}
