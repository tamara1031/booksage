...
func NewSagaOrchestrator(v repository.VectorRepository, g repository.GraphRepository, dr database.DocumentRepository, sr database.SagaRepository) *SagaOrchestrator {
...
func (o *SagaOrchestrator) RunIngestionSaga(ctx context.Context, saga *models.IngestSaga, chunks []map[string]any, graphNodes []map[string]any) error {
	...
	if err := o.graphStore.InsertNodesAndEdges(ctx, strID, graphNodes, nil); err != nil {
