...
func (b *GraphBuilder) BuildGraphElements(docID string, entities []domain.Entity, relations []domain.Relation, treeNodes []map[string]any) ([]map[string]any, []map[string]any) {
