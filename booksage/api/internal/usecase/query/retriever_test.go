...
func (m *mockQdrant) Search(ctx context.Context, vector []float32, limit int) ([]domain.SearchResult, error) {
	return []domain.SearchResult{{ID: "1", Content: "Vector result", Score: 0.9, Source: "vector"}}, nil
}
...
func (m *mockNeo4j) SearchChunks(ctx context.Context, query string, limit int) ([]domain.SearchResult, error) {
	return []domain.SearchResult{{ID: "2", Content: "Graph result", Score: 0.8, Source: "graph"}}, nil
}
